...
- **Names:** Chapelloise's second scrubber section is `Exchanges`; `Progression` now only means the eight-count change of partner. Bourrée's second section is `Crossings`, matching the tree's `Crossing`. The Schottische origin reads “precise origin disputed”, as this audit already stated, and its source link uses the display spelling. Its id is now `schottische` too. Checked afterwards: AccroFolk says “d'origine incertaine, elle serait allemande ou hongroise”, English Wikipedia says Bohemia without a citation, and the Oxford Companion says only Continental Europe, so the accounts do differ. “Drumul Draculi” in recording titles is the artists' spelling.
...
Each origin string was checked against at least one source beyond the step sheet. This checks the claim shown in the interface, not the full history of each dance. Wikipedia articles are named as such; several are stubs or carry uncited statements.

| Dance | Origin shown | Evidence | Verdict |
| --- | --- | --- | --- |
| Bourrée bancale | France | [Folk à Bourk](https://www.folkabourk.fr/apprendre) names it “Bourrée bancale version simple (à 6)” and gives no provenance. Several workshop videos title the same six-person dance “Bourrée à 6 – rue Bancale – Bourbonnaise” and say the original has two men and four women. | Correct but vague. Bourbonnais rests on video titles only, so it is not shown. |
| Chapelloise | France; earlier origin disputed | [Wikipedia](https://en.wikipedia.org/wiki/Chapelloise): introduced in France in the 1930s by Alick-Maud Pledge, named after Chapelle-des-Bois in the 1970s; the Swedish “Aleman's marsj” claim is contested; known in Scandinavia as All American Promenade; shares its first eight bars with the Gay Gordons (1907). | Supported. |
| Cercle circassien | Britain; collected in Northumberland, England | [Collection history](https://laine.artsci.utoronto.ca/folkdans/misc/circassian_en.htm): printed in England and the USA from the 1830s–50s; Maud Karpeles collected the current form in Netherwitton, Northumberland. [French Wikipedia](https://fr.wikipedia.org/wiki/Cercle_circassien) gives Scotland (Lanarkshire) and northern England, and calls any Circassian link uncertain. | Changed from “England, United Kingdom”, which left out Scotland. |
| Branle de Noirmoutier | Île de Noirmoutier, Vendée, France | [French Wikipedia](https://fr.wikipedia.org/wiki/Branle_de_Noirmoutier) (a stub without citations): typical of the island, collected in the commune of L'Épine, also called branle de l'Épine. [Lannig](https://lannig.e-monsite.com/pages/pays-nantais/retz/branle-de-noirmoutiers.html) does not use that alias, and says the four-beat offset between fronts is not proven. | Made more precise. The alias has only weak support. |
| Waltz | Austria and southern Germany | [Wikipedia](https://en.wikipedia.org/wiki/Waltz): German-speaking regions, 18th century; Bavaria, Tyrol and Styria about 1750; fashionable in Vienna in the 1780s. | Supported. |
| Schottische | Central Europe; precise origin disputed | See the follow-up above: German or Hungarian (AccroFolk), Bohemia (English Wikipedia, uncited), Continental Europe (Oxford Companion). | Supported. |
| Mazurka | Poland; balfolk adaptation | [Wikipedia](https://en.wikipedia.org/wiki/Mazurka): from the Polish mazur, kujawiak and oberek; the name refers to Mazovia. The French form dropped the hop on three. | Supported. |
| Hanter-dro, An dro | Pays vannetais (Morbihan), Brittany, France | French Wikipedia on [hanter-dro](https://fr.wikipedia.org/wiki/Hanter-dro) and [an-dro](https://fr.wikipedia.org/wiki/An-dro): “danse bretonne originaire du pays vannetais”. | Made more precise; Morbihan was correct. |
| Tzadik Katamar | Israel | [Folkdance Footnotes](https://folkdancefootnotes.org/dance/a-real-folk-dance-what-is-it/2nd-generation-dances/tzadik-katamar-israel/): choreographed by Yonatan Gabay in 1965 (one listing says 1969) to a melody by Amitai Ne'eman, Psalm 92:13. | Supported. |
| Drumul Dracului | Moldavia, Romania (Hungarian Csángó tradition) | [SoCal notes](https://socalfolkdance.org/dances/D/Drumul_Dracului.pdf): “Moldvai-Csángó, Rumania”, a Hungarian-speaking group around Bacău; sources Zoltan Farkas and Ferenc Sára; closed circle. [Hardwick](https://duramecho.com/Dance/BEECIIFolkDance/Drumul_Dracului.html): Csángó, of Hungarian origin. | Made more precise; the earlier string was correct. |
